  ...
  render(){
    return (
      <div>
        ...
        <input type="text" onChange={this.handleChange.bind(this)} value={this.state.searchTerm} name="searchTerm"></input>
        </form>
        {this.state.isSubmitted && <Redirect to={{pathname: '/search', results: this.props.results, searchTerm: this.state.searchTerm}}/>}
      </div>
    )
  }
}
